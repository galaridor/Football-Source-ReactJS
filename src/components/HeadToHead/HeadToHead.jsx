    ...
    return (
      <div className={`${styles["head-to-head-section"]}`}>
        ...
        <h3 className={`${styles["matches-title"]}`}>
          {aggregates.homeTeam.name} vs {aggregates.awayTeam.name} Previous
          Matches
        </h3>
        <div className={styles["widget-header"]}>
          ...
          >
            ...
            <Column
              header="Home Team Emblem"
              body={homeTeamEmblemBodyTemplate}
            />
            <Column field="score" header="Result" body={scoreData} />
            <Column
              header="Away Team Emblem"
              body={awayTeamEmblemBodyTemplate}
            />
